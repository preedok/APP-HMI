  ...
  return (
    <View style={styles.container}>
      ...
      <Card>
        ...
        <ImageBackground style={styles.bg} source={require('../../../assets/kongres.jpg')} />
        <View style={styles.overlay} />
        {/* <Text style={styles.title}>{itemData.tittle}</Text> */}
        <Text style={styles.title}>Test Info Training</Text>
      ...
      {itemData &&
        ...
        itemData.ingredients.split(',').map((ingredient, index) => (
          <View style={styles.listItemContainer} key={index}>
            ...
            /> */}
            <Text style={styles.list}>Coming Soon...</Text>
          </View>
        ))}
    </View>
  );
